...
You must only decide a part from the Body model. The system will not search for labeled parts outside of the Body model.
{% endstep %}
...
Rename the part you want to use to "PromptPart". The name is case-sensitive.
